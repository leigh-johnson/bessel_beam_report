...
\begin{table*}[tb]
  ...
  \begin{ruledtabular}
    \begin{tabular}{lcccc}
      Candidate & Dataset   & $z_R$ measured (m)        & $z_R$ geometric (m) & $z_R$ QDHT (m) \\
      \colrule
      \#1       & Jul 22-23 & 0.5 ($z \in [1.36,1.86]$) & 1.34-1.91           & 1.39-1.76      \\
      \#2       & Jul 29-30 & TODO                      & 1.23-2.41           & 1.34-2.18      \\
      \#3       & Aug 5-6   & TODO                      & 1.18-1.76           & 1.24-1.60      \\
    \end{tabular}
  \end{ruledtabular}
\end{table*}
...
\begin{table*}[h]
  ...
  diameter of the Gaussian input beam at axicon~1, and ($\lambda=\SI{650}{\nano\meter}$) is the wavelength of the input laser diode. Axicons were sourced from Thorlabs (AX255-A, AX2505-A), manufactured from UV Fused Silica substrate ($n \approx 1.4565$ at 650nm) with AR coating for 350-700nm range.
  \label{tab:configs}}
  \begin{ruledtabular}
    \begin{tabular}{lcccc}
      Candidate \#, Description                          & $L_{12}$ (mm) & $L_{23}$ (mm) & $D_{\text{in}}$ (mm) &
      $2\times$ telescope                                                                                                                     \\
      \colrule
